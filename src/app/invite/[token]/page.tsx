            ...
            <div className="p-8 text-center">
              ...
              <div className="flex justify-center mb-5">
                {inviteData?.created_by_avatar ? (
                  ...
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-white text-3xl font-bold ring-4 ring-emerald-100 shadow-md">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2 leading-tight">
                <span className="text-emerald-600">{inviteData?.created_by_name}</span>
