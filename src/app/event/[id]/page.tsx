        ...
        <div className="bg-white dark:bg-gray-900 rounded-t-3xl shadow-2xl dark:shadow-black/30 mx-auto max-w-lg overflow-hidden">
          ...
          <div className="px-5 pt-3 pb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Invite someone</h3>
              <button onClick={onClose} className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Phone <span className="font-normal normal-case">(optional)</span></label>
                <input
                  value={phone}
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1">Email <span className="font-normal normal-case">(optional)</span></label>
                <input
                  value={email}
              ...
              <div className="flex gap-3 pt-1">
                <button type="button" onClick={onClose} className="flex-1 py-3 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 font-semibold rounded-xl text-sm hover:bg-gray-50 dark:hover:bg-gray-800">
                  Cancel
                </button>
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-6">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">{error ?? 'Event not found'}</h2>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="sticky top-0 z-10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-lg mx-auto px-4 h-14 flex items-center gap-3">
          <button onClick={() => router.back()} className="w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-500 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600">
          ...
          <span className="font-semibold text-gray-900 dark:text-white truncate flex-1">{event.title}</span>
          {event.visibility === 'private' && (
            <span title="Private event" className="text-gray-400 dark:text-gray-500">🔒</span>
          )}
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5">
        ...
        {/* Hero card */}
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm dark:shadow-black/20 border border-gray-100 dark:border-gray-700 overflow-hidden">
          ...
          <div className="px-5 py-4 space-y-3">
            ...
            <div className="flex items-start gap-3">
              <div className="w-9 h-9 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 flex items-center justify-center flex-shrink-0">
                <svg viewBox="0 0 24 24" className="w-4 h-4 text-indigo-600 dark:text-indigo-400" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round">
                  <rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>
                </svg>
              </div>
              <div>
                <p className="text-sm font-semibold text-gray-900 dark:text-white">{formatEventDate(event.starts_at)}</p>
                {event.ends_at && (
            ...
            <div className="flex items-start gap-3">
              <div className="w-9 h-9 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 flex items-center justify-center flex-shrink-0">
                <svg viewBox="0 0 24 24" className="w-4 h-4 text-indigo-600 dark:text-indigo-400" fill="currentColor">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
              </div>
              <div>
                <p className="text-sm font-semibold text-gray-900 dark:text-white">{event.location_name}</p>
                {event.address && <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{event.address}</p>}
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-gray-400 dark:text-gray-500">Organized by</p>
            ...
            {/* Description */}
            {event.description && (
              <p className="text-sm text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700/50 rounded-xl px-4 py-3 leading-relaxed">
                {event.description}
              </p>
            )}
        ...
        {myAttendee && !isOrganizer && (
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm dark:shadow-black/20 border border-gray-100 dark:border-gray-700 px-5 py-4">
            <h3 className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-3">Your RSVP</h3>
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-600 dark:text-gray-300 font-semibold text-sm disabled:opacity-40 transition-colors"
                >
                  ✗ Decline
                </button>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm dark:shadow-black/20 border border-gray-100 dark:border-gray-700 px-5 py-4">
          <div className="flex items-center justify-between mb-3">
            ...
            {isOrganizer && (
              <button
                ...
                className="flex items-center gap-1.5 text-xs text-indigo-600 dark:text-indigo-400 font-semibold hover:text-indigo-700 dark:hover:text-indigo-300"
              >
          ...
          {attendees.length === 0 ? (
            <p className="text-sm text-gray-400 dark:text-gray-500 py-2">No one invited yet.</p>
          ) : (
            <ul className="space-y-2">
              {attendees.map(a => (
                <li key={a.id} className="flex items-center gap-3">
                  <InitialAvatar name={a.display_name} size="sm" />
                  <span className="flex-1 text-sm font-medium text-gray-900 dark:text-white">{a.display_name}</span>
